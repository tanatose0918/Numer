...
class Trapzoidal extends Component {
    ...
    render() {
        return (
            <div>
                <h2 className="Head1"> Trapzoidal Rule</h2>
                    ...
                    <Card onChange={this.handleChange} style={{ padding: '0 50px', width: '100%%', borderRadius: "15px" }}>
                        ...
                        <Col span={8}>
                            ...
                            <div style={{ textAlign: "end" }}>
                                <Button id="submit_button" style={{ backgroundColor: "rgb(9, 68, 122)", color: "white", fontSize: "20px", marginTop: 20, alignItems: "center" }} onClick={() => this.trapzoidal(parseInt(this.state.a), parseInt(this.state.b))} >Submit</Button>
                            </div>
                        </Col>
                    </Card>
